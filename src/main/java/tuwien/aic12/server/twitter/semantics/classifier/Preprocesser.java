...
public class Preprocesser {
     ...
     *
     * @param item the tweet to modify
     * @return the tweet with "URL" in place of the terms that start with
     * "http://" or "www."
     */
     ...
     *
     * @param item the tweet to modify
     * @return the tweet with "_SMILEHAPPY_" in place of happy emoticons and
     * "_SMILESAD_" in place of sad emticons
     */
     ...
     *
     * @param item the tweet to modify
     * @return the tweet without characters that are repeated more than three
     * times
     */
     ...
     *
     * @param item the tweet to modify
     * @return the tweet with "STRLAUGH" in place of strings that represent a
     * laugh
     */
