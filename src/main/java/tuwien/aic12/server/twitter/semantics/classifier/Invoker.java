...
import tuwien.aic12.server.twitter.semantics.commands.*;
...
public class Invoker {
     ...
     * @param cwmc command that represent the action for constructing a weighted
     * majority classifier
     * @param calcPrec command that represent the action for calculating
     * weighted majority's precision
     */
